				...
				if options.fit_tails:
					if '7TeV' in config.periods :
						if 'em' in config.channels :
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-7TeV-0.root -c em -e 7TeV -b 'Fakes_fine_binning' -k '8' --range 150  ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-7TeV-0.root -c em -e 7TeV -b 'EWK_fine_binning' -k '9' --range 200  ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-7TeV-0.root -c em -e 7TeV -b 'EWK_fine_binning' -k '8' --range 200  ".format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-7TeV-0.root -c em -e 7TeV -b 'ttbar_fine_binning' -k '9' --range 200  ".format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-7TeV-0.root -c em -e 7TeV -b 'ttbar_fine_binning' -k '8' --range 200 ".format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-7TeV-0.root -c em -e 7TeV -b 'ttbar_fine_binning_CMS_htt_TTbarShape_em_nobtag_7TeVDown' -k '8' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-7TeV-0.root -c em -e 7TeV -b 'ttbar_fine_binning_CMS_htt_TTbarShape_em_nobtag_7TeVUp'   -k '8' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-7TeV-0.root -c em -e 7TeV -b 'ttbar_fine_binning_CMS_htt_TTbarShape_em_btag_7TeVDown' -k '9' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-7TeV-0.root -c em -e 7TeV -b 'ttbar_fine_binning_CMS_htt_TTbarShape_em_btag_7TeVUp'   -k '9' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
						if 'et' in config.channels :
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-7TeV-0.root -c et -e 7TeV -b 'QCD_fine_binning' -k '8' --range 200 ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-7TeV-0.root -c et -e 7TeV -b 'W_fine_binning' -k '8' --range 200 ".format(DIR=dir, ANA=ana)) 
							## tail fit for QCD shape uncertainties
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-7TeV-0.root -c et -e 7TeV -b 'QCD_CMS_htt_QCDShape_etau_nobtag_7TeVDown_fine_binning' -k '8' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-7TeV-0.root -c et -e 7TeV -b 'QCD_CMS_htt_QCDShape_etau_nobtag_7TeVUp_fine_binning'   -k '8' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-7TeV-0.root -c et -e 7TeV -b 'W_CMS_htt_WShape_etau_nobtag_7TeVDown_fine_binning' -k '8' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-7TeV-0.root -c et -e 7TeV -b 'W_CMS_htt_WShape_etau_nobtag_7TeVUp_fine_binning'   -k '8' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-7TeV-0.root -c et -e 7TeV -b 'W_CMS_htt_WShape_etau_btag_7TeVDown_fine_binning' -k '9' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-7TeV-0.root -c et -e 7TeV -b 'W_CMS_htt_WShape_etau_btag_7TeVUp_fine_binning'   -k '9' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
						if 'mt' in config.channels :
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-7TeV-0.root -c mt -e 7TeV -b 'QCD_fine_binning' -k '9' --range 120".format(DIR=dir, ANA=ana))
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-7TeV-0.root -c mt -e 7TeV -b 'QCD_fine_binning' -k '8' --range 150 --rangelast 700 ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-7TeV-0.root -c mt -e 7TeV -b 'W_fine_binning' -k '8' --range 300 ".format(DIR=dir, ANA=ana))
							## tail fit for QCD shape uncertainties
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-7TeV-0.root -c mt -e 7TeV -b 'QCD_CMS_htt_QCDShape_mutau_nobtag_7TeVDown_fine_binning' -k '8' --range 150 --rangelast 700 --no-uncerts".format(DIR=dir, ANA=ana))
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-7TeV-0.root -c mt -e 7TeV -b 'QCD_CMS_htt_QCDShape_mutau_nobtag_7TeVUp_fine_binning'   -k '8' --range 150 --rangelast 700 --no-uncerts".format(DIR=dir, ANA=ana))
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-7TeV-0.root -c mt -e 7TeV -b 'QCD_CMS_htt_QCDShape_mutau_btag_7TeVDown_fine_binning' -k '9' --range 120  --no-uncerts".format(DIR=dir, ANA=ana))
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-7TeV-0.root -c mt -e 7TeV -b 'QCD_CMS_htt_QCDShape_mutau_btag_7TeVUp_fine_binning'   -k '9' --range 120  --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-7TeV-0.root -c mt -e 7TeV -b 'W_CMS_htt_WShape_mutau_nobtag_7TeVDown_fine_binning' -k '8' --range 300 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-7TeV-0.root -c mt -e 7TeV -b 'W_CMS_htt_WShape_mutau_nobtag_7TeVUp_fine_binning'   -k '8' --range 300 --no-uncerts".format(DIR=dir, ANA=ana))
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-7TeV-0.root -c mt -e 7TeV -b 'W_CMS_htt_WShape_mutau_btag_7TeVDown_fine_binning' -k '9' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-7TeV-0.root -c mt -e 7TeV -b 'W_CMS_htt_WShape_mutau_btag_7TeVUp_fine_binning'   -k '9' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
					if "8TeV" in config.periods :
						if 'em' in config.channels :
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-8TeV-0.root -c em -e 8TeV -b 'Fakes_fine_binning' -k '8' --range 200  ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-8TeV-0.root -c em -e 8TeV -b 'EWK_fine_binning' -k '9' --range 200  ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-8TeV-0.root -c em -e 8TeV -b 'EWK_fine_binning' -k '8' --range 200 " .format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-8TeV-0.root -c em -e 8TeV -b 'ttbar_fine_binning' -k '9' --range 200  ".format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-8TeV-0.root -c em -e 8TeV -b 'ttbar_fine_binning' -k '8' --range 200 ".format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-8TeV-0.root -c em -e 8TeV -b 'ttbar_fine_binning_CMS_htt_TTbarShape_em_nobtag_8TeVDown' -k '8' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-8TeV-0.root -c em -e 8TeV -b 'ttbar_fine_binning_CMS_htt_TTbarShape_em_nobtag_8TeVUp'   -k '8' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-8TeV-0.root -c em -e 8TeV -b 'ttbar_fine_binning_CMS_htt_TTbarShape_em_btag_8TeVDown' -k '9' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_em.inputs-mssm-8TeV-0.root -c em -e 8TeV -b 'ttbar_fine_binning_CMS_htt_TTbarShape_em_btag_8TeVUp'   -k '9' --range 200 --no-uncerts".format(DIR=dir, ANA=ana))
						if 'et' in config.channels :
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'QCD_fine_binning' -k '9' --range 120 ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'QCD_fine_binning' -k '8' --range 120 ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'TT_fine_binning' -k '9' --range 150 ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'TT_fine_binning' -k '8' --range 120 ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'W_fine_binning' -k '9' --range 150 ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'W_fine_binning' -k '8' --range 300".format(DIR=dir, ANA=ana)) 
							## tail fit for QCD shape uncertainties
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'QCD_CMS_htt_QCDShape_etau_nobtag_8TeVDown_fine_binning' -k '8' --range 120 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'QCD_CMS_htt_QCDShape_etau_nobtag_8TeVUp_fine_binning'   -k '8' --range 120 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'QCD_CMS_htt_QCDShape_etau_btag_8TeVDown_fine_binning' -k '9' --range 120 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'QCD_CMS_htt_QCDShape_etau_btag_8TeVUp_fine_binning'   -k '9' --range 120 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'W_CMS_htt_WShape_etau_nobtag_8TeVDown_fine_binning' -k '8' --range 300 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'W_CMS_htt_WShape_etau_nobtag_8TeVUp_fine_binning'   -k '8' --range 300 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'W_CMS_htt_WShape_etau_btag_8TeVDown_fine_binning' -k '9' --range 150 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_et.inputs-mssm-8TeV-0.root -c et -e 8TeV -b 'W_CMS_htt_WShape_etau_btag_8TeVUp_fine_binning'   -k '9' --range 150 --no-uncerts".format(DIR=dir, ANA=ana))
						if 'mt' in config.channels : 
							##os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-8TeV-0.root -c mt -e 8TeV -b 'QCD_fine_binning' -k '8' --range 200 --rangelast 700 ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-8TeV-0.root -c mt -e 8TeV -b 'W_fine_binning' -k '9' --range 150 ".format(DIR=dir, ANA=ana))           
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-8TeV-0.root -c mt -e 8TeV -b 'W_fine_binning' -k '8' --range 300".format(DIR=dir, ANA=ana))           
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-8TeV-0.root -c mt -e 8TeV -b 'TT_fine_binning' -k '9' --range 200 ".format(DIR=dir, ANA=ana))           
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-8TeV-0.root -c mt -e 8TeV -b 'TT_fine_binning' -k '8' --range 200 ".format(DIR=dir, ANA=ana))           
							## tail fit for QCD shape uncertainties
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-8TeV-0.root -c mt -e 8TeV -b 'QCD_CMS_htt_QCDShape_mutau_nobtag_8TeVDown_fine_binning' -k '8' --range 200 --rangelast 700 --no-uncerts".format(DIR=dir, ANA=ana))
							#os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-8TeV-0.root -c mt -e 8TeV -b 'QCD_CMS_htt_QCDShape_mutau_nobtag_8TeVUp_fine_binning'   -k '8' --range 200 --rangelast 700 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-8TeV-0.root -c mt -e 8TeV -b 'W_CMS_htt_WShape_mutau_nobtag_8TeVDown_fine_binning' -k '8' --range 300 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-8TeV-0.root -c mt -e 8TeV -b 'W_CMS_htt_WShape_mutau_nobtag_8TeVUp_fine_binning'   -k '8' --range 300 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-8TeV-0.root -c mt -e 8TeV -b 'W_CMS_htt_WShape_mutau_btag_8TeVDown_fine_binning' -k '9' --range 150 --no-uncerts".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_mt.inputs-mssm-8TeV-0.root -c mt -e 8TeV -b 'W_CMS_htt_WShape_mutau_btag_8TeVUp_fine_binning'   -k '9' --range 150 --no-uncerts".format(DIR=dir, ANA=ana))
						if 'tt' in config.channels :
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_tt.inputs-mssm-8TeV-0.root -c tt -e 8TeV -b 'QCD_fine_binning' -k '9' --range 200 ".format(DIR=dir, ANA=ana))
							os.system("addFitNuisance.py -s {DIR}/{ANA} -i htt_tt.inputs-mssm-8TeV-0.root -c tt -e 8TeV -b 'QCD_fine_binning' -k '8' --range 200 ".format(DIR=dir, ANA=ana))
						## cleanup
...
if __name__ == '__main__':
	...
	parser = OptionParser(usage="usage: %prog [options]", description="Script to setup all datacards and directories.'")
	
	parser.add_option("-a", "--analyses",
		dest="analyses",
		default="bbb, plain",
	...
	parser.add_option("--SMHasBackground",
		dest="SMHasBackground",
		default=False,
		action="store_true",
		help="Add the SM Higgs to the background. [Default: False]")
	
	parser.add_option("--SMHasSignal",
		dest="SMHasSignal",
		default=False,
		action="store_true",
	...
	parser.add_option("--blind-datacards",
		dest="blind_datacards",
		default=False,
		action="store_true",
		help="Option to blind datacards. Also needs to be turned on to inject SM to datacards. [Default: False]")
	
	parser.add_option("--extra-templates",
		dest="extra_templates",
		default="",
		type="string",
		help="List of extra background or signal templates which should be injected to the asimov dataset. Needs to be comma seperated list. Here used to inject SM signal into MSSM datacards. [Default: \"\"]")
	...
	parser.add_option("--new-merging",
		dest="new_merging",
		default=False,
		action="store_true",
		help="added to test the new merging introduced by Andrew. [Default: False]")
	
	parser.add_option("--new-merging-threshold",
		dest="new_merging_threshold",
		default="0.5",
		type="string",
		help="Threshold for the new merging by Andrew. [Default: \"0.5\"]")
	
	parser.add_option("--drop-normalize-bbb",
		dest="drop_normalize_bbb",
		default=False,
		action="store_true",
	...
	options.masses = [mass.rstrip(',') for mass in masses]
	
	
## analyses
	analyses = options.analyses.split()
	#for idx in range(len(analyses)) : analyses[idx] = analyses[idx].rstrip(',')
	options.analyses = [analysis.rstrip(',') for analysis in analyses]
